...
+
----
$ podman pull registry.redhat.io/3scale-amp2/toolbox-rhel7:3scale2.9.0
----
. Verify the installation:
+
----
$ podman run --rm registry.redhat.io/3scale-amp2/toolbox-rhel7:3scale2.9 3scale help
----
+
.Expected Output
----
...
+
----
$ podman run --name toolbox-container registry.redhat.io/3scale-amp2/toolbox-rhel7:3scale2.9.0 3scale remote add rhoam https://<ACCESS_TOKEN>@<3SCALE_HOSTNAME>
----
